...
class CardFullInfoUserInvoice extends StatelessWidget {
  final Usuario usuario;
  const CardFullInfoUserInvoice({super.key, required this.usuario});
